...
//            if (r) {
//                $.post("/Account/LogOut", function (data) { location.href = '/Account/Index'; }, "json");
...
function createFrame(url) {
    var s = '<iframe frameborder="0" src="' + url + '" scrolling="auto" style="width:100%; height:100%"></iframe>';
    return s;
}
