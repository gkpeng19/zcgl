...
KindEditor.ready(function (K) {
    editor1 = K.create('#content', {
        ...
        newlineTag: 'br',
        items: [
						'bold', 'italic', 'underline', 'emoticons', 'fontname', 'fontsize', 'forecolor', 'hilitecolor', 'link'
					]
    });
});
...
function refresh_newMessage() {
    //调用服务器方法获取最新消息人列表
    $.post("../../WebIM/GetNewMessages", function (data) {
        if (data == "|")//没有任何动静，什么也不需要做了
            return;
        var CurrentMember = "";
        var str = new Array();
...
$(function () {
    ...
    $("#ChatLog").click(function () {
        $('#ChatLogdialog').dialog({ title: 'Chat Log', width: 600, height: 435, resizable: false, collapsible: true, minimizable: false, maximizable: false });
    ...
    $("#SendMessage").click(function () {
        ...
        var receiverName = "";
        if ($(".webim-info-tit-name .current").html() != null) {
            var str = "<p class='tit'><strong>[我]</strong> <span>" + mydate.getFullYear() + "-" + mydate.getMonth() + "-" + mydate.getDay() + " " + mydate.getHours() + ":" + mydate.getMinutes() + ":" + mydate.getSeconds() + "</span>：</p><p>" + editor1.html() + "</p>";
            ...
            var str = "<p class='tit'><strong>[我] 对 ｛" + receiverName + "｝ 广播</strong> <span>" + mydate.getFullYear() + "-" + mydate.getMonth() + "-" + mydate.getDay() + " " + mydate.getHours() + ":" + mydate.getMinutes() + ":" + mydate.getSeconds() + "</span>：</p><p>" + editor1.html() + "</p>";
            //去掉[]和最后一个逗号
        }
        //发到前台
