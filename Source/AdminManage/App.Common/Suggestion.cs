...
namespace App.Common
{
    public static class Suggestion
    {
        ...
        public static string PlaseChooseToztRecords { get { return "请选择要图层类型为基础图层的记录"; } }
        ...
        public static string IsEditable { get { return "是否编辑"; } }

        public static string SaveFail { get { return "保存失败"; } }
        ...
        public static string YouWantToDeleteXY { get { return "您确定要删除所选图层的地图范围吗？"; } }
    }
}
