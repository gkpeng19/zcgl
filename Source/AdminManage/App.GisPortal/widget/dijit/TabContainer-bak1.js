...
function (declare, domClass, arrayUtils, query, _WidgetBase, _TemplatedMixin,
    Memory, xhr, domConstruct, Trackable, domStyle, domAttr, dom, topic, OnDemandGrid, Selection, EditFeatureDialog,
    ...
    clazz = declare([_WidgetBase, _TemplatedMixin], {
        ...
        postCreate: function () {
            instance = this;
            if (this.feature) {
                this.jzObjCode.innerHTML = this.feature.attributes["OBJCODE"] ? this.feature.attributes["OBJCODE"] : "属性信息为空";
                this.jzObjName.innerHTML = this.feature.attributes["OBJNAME"] ? this.feature.attributes["OBJNAME"] : "属性信息为空";
        ...
        startup: function () {
            ...
            this.getParams();
            topic.subscribe('topic/UploadFileSuccess', this.getAttachments);
        },
        getParams: function () {
        ...
        onEditFeature: function () {
            EditFeatureDialog.getInstance().startup(that.layerIndex, that.objID);
        },
