...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/topic', 'dojo/parser', 'dijit/_WidgetBase',
    ...
    'dijit/_TemplatedMixin', 'dojo/on', 'dojo/dom', 'dojo/dom-construct', 'dojo/dom-attr',
...
function (declare, lang, topic, parser, _WidgetBase, arrayUtils, SWFUpload, DeferredList, xhr,
    _TemplatedMixin, on, dom, domConstruct, domAttr, domStyle, query, UploadProgress, template) {
        ...
        createNode: function () {
            ...
            if (that.results[0][0]) {
                arrayUtils.forEach(that.results[0][1], function (pic) {
                    ...
                    htmlStr += "<div id='jzPic_" + pic.ID + "' class='item clearfix'><div class='col c1' style='width: 38%;'><div class='name'><span class='name-text-wrapper'><span class='name-text enabled'>" + pic.PICDES + "</span></span></div></div><div class='col' style='width: 35%'>" + addDate + "</div><div class='col' style='width: 15%'>图片</div><div class='col' style='width: 10%'><a data-id='" + pic.ID + "' class='jzDeleteUploadPics' href='javascript:void(0)'>删除</a></div></div>";
                    //htmlStr += "<div id='jzPic_" + pic.ID + "' class='item clearfix'><div class='col c1' style='width: 45%;'><span class='chk'><span class='chk-ico'></span></span><div class='name'><span class='name-text-wrapper'><span class='name-text enabled'>" + pic.PICDES + "</span></span></div></div><div class='col' style='width: 35%'>" + addDate + "</div><div class='col' style='width: 19%'>图片</div></div>";
                });
            }
            ...
            if (that.results[1][0]) {
                arrayUtils.forEach(that.results[1][1], function (pic) {
                    ...
                    //实例化一个新的日期格式，使用1970 年 1 月 1 日至今的毫秒数为参数
                    var addDate = new Date(milliseconds).Format("yyyy-MM-dd hh:mm:ss");
                    videoStr += "<div id='jzVideo_" + pic.ID + "' class='item clearfix'><div class='col c1' style='width: 38%;'><div class='name'><span class='name-text-wrapper'><span class='name-text enabled'>" + pic.VIDEODES + "</span></span></div></div><div class='col' style='width: 35%'>" + addDate + "</div><div class='col' style='width: 15%'>视频</div><div class='col' style='width: 10%'><a data-id='" + pic.ID + "' class='jzDeleteUploadVideos' href='javascript:void(0)'>删除</a></div></div>";
                    //videoStr += "<div id='jzVideo_" + pic.ID + "' class='item clearfix'><div class='col c1' style='width: 45%;'><span class='chk'><span class='chk-ico'></span></span><div class='name'><span class='name-text-wrapper'><span class='name-text enabled'>" + pic.VIDEODES + "</span></span></div></div><div class='col' style='width: 35%'>" + addDate + "</div><div class='col' style='width: 19%'>视频</div></div>";
                });
            }
            if (videoStr) {
