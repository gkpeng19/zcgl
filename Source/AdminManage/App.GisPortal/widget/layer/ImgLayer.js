define("widget/layer/ImgLayer", ['dojo/_base/declare', 'esri/layers/TiledMapServiceLayer', 'esri/layers/TileInfo', 'esri/geometry/Extent', 'esri/SpatialReference'],
    function (declare, TiledMapServiceLayer, TileInfo, Extent, SpatialReference) {
        ...
        return declare([TiledMapServiceLayer], {
            ...
            getTileUrl: function (level, row, col) {
                return "http://10.246.0.81:9000/service/ImageEngine/picdis/abc?SERVICE=WMTS&REQUEST=GetTile&version=1.0.0&LAYER=Sate_Rv_" + this.year + "&style=default&format=image/png&TileMatrixSet=nativeTileMatrixSet&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&username=syllhjxxjx&password=syllhjxxjx123";
                //return "http://172.24.254.188/service/ImageEngine/picdis/abc?SERVICE=WMTS&REQUEST=GetTile&version=1.0.0&LAYER=Sate_Rv_" + this.year + "&style=default&format=image/png&TileMatrixSet=nativeTileMatrixSet&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&username=syllhjxxjx&password=syllhjxxjx123";
            }
        });
    });