define(['dojo/_base/declare',
    ...
    function (declare, xhr, query, dom, domAttr, domStyle, domClass, domConstruct, baseFx, fx,
        ...
        Scalebar, OverviewMap, Popup, Event, easing,
        ...
        //初始化横向菜单
        var menus = {
            dbfx: '<li><a id="constrast-analyst" style="cursor: pointer">对比分析</a></li>',
            ...
            ptgl: '<li><a href="http://10.246.0.81:8089/" target="_blank">平台管理</a></li>',
...
document.addEventListener("msfullscreenchange", function () {
    ...
    fullscreenState.innerHTML = (document.msFullscreenElement)? "" : "not ";}, false);
        */
        ...
        function initMap() {
            require(['esri/map', 'esri/tasks/GeometryService', 'esri/toolbars/navigation', 'widget/dijit/LoadingIndicator'],
                function (Map, GeometryService, EsriNavigation, LoadingIndicator) {
                    //先显示地图
                    showMap();
        ...
        function addStreetMap(evt) {
            if (evt.level >= 10) {
                if (!streetLayer) {
                    ...
                    var symbol = new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([150, 204, 248, 0.8]), 10);
        ...
        function createMap(poi, px, py) {
            var sMapDiv = top.frames['streetMapFrame'].document.getElementById('jz-street-mapDiv');
            if (!JZ.smc) {
                ...
                var baseMapLayer = new ArcGISTiledMapServiceLayer(JZ.baselayers[0].SERVICEURL);
